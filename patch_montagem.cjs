...
// We need to completely rewrite renderAutoMontagem
...
const endIndex = content.indexOf('export function renderAutoPortas(kits: any[], responsavel?: string, obra?: string, cliente?: string) {');
...
`;
  ...
  console.log("Patched renderAutoMontagem");
} else {
